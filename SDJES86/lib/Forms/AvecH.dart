...
class AvecHData {
  ...
  /*AvecHData({
    ...
    this.radio227_5 = '',
    this.radio227_29 = '',
    this.observations227_5 = '',
    this.observations227_29 = '',
    this.capaciteAccueil = '',
    this.moinsDe6AnsDeclares = '',
    this.entre6et13AnsDeclares = '',
    this.entre14et17AnsDeclares = '',
    this.moinsDe6AnsPresents = '',
    this.entre6et13AnsPresents = '',
    this.entre14et17AnsPresents = '',
    this.moinsDe6AnsHandi = '',
    this.entre6et13AnsHandi = '',
    this.entre14et17AnsHandi = '',
    this.totalDeclares = '',
    this.totalPresents = '',
    this.totalHandi = '',
    this.radio2324_13 = '',
    this.radio2324_14 = '',
    this.observations2324_13 = '',
    this.observations2324_14 = '',
    this.radioRegistreMineur = '',
    this.observationsRegistreMineur = '',
    this.directeurNom = '',
    this.directeurPrenom = '',
    this.directeurQualification = '',
    this.radioTitulaireStagiaire = '',
    this.adjointNom = '',
    this.adjointPrenom = '',
    this.adjointQualif = '',
    this.nombreAnimQualif = '',
    this.nombreAnimStagiaires = '',
    this.nombreAnimNonQualif = '',
    this.totalAnim = '',
    this.encadrementRequisMoinsDe6 = '',
    this.encadrementRequisPlusDe6 = '',
    this.totalAnimRequis = '',
    this.radio227_2 = '',
    this.observations227_2 = '',
    this.radioArrete3_5 = '',
    this.observationsArrete3_5 = '',
    this.radio9_02_07 = '',
    this.observations9_02_07 = '',
    this.radio227_8 = '',
    this.observations227_8 = '',
    this.radioSuiviSanitaire = '',
    this.observationsSuiviSanitaire = '',
    this.observationsCommunicationOrganisateur = '',
    this.observationsSavoirComportement = '',
    this.observationsQualifPersonnel = '',
    this.observationsTempsDePrep = '',
    this.observationsReuBilan = '',
    this.observationsEvalStg = '',
    this.radioProjEdu = '',
    this.observationsProjEdu = '',
    this.radioProjPeda = '',
    this.observationsProjPeda = '',
    this.radioRepresentant = '',
    this.observationsRepresentant = '',
    this.observationsPE = '',
    this.observationsMoyens = '',
    this.observationsMoyensEquipe = '',
    this.observationsBudget = '',
    this.observationsOrientation = '',
    this.observationsDiagnostic = '',
    this.observationsPolitique = '',
    this.observationsReorientation = '',
    this.observationsPPCoherence = '',
    this.observationsPPCara = '',
    this.observationsPPConcertation = '',
    this.observationsPPModalite = '',
    this.observationsPPNature = '',
    this.observationsPPRepartition = '',
    this.observationsSecuriteNuit = '',
    this.observationsPPSanteHandi = '',
    this.observationsPPFonctEquipe = '',
    this.observationsPPEvalAccueil = '',
    this.observationsActivitesType = '',
    this.observationsPrestataire = '',
    this.observationsActiviteMineur = '',
    this.observationsRisques = '',
    this.observationsEchange = '',
    this.observationsFormation = '',
    this.nomActivite = '',
    this.encadrantNomPrenomACM = '',
    this.encadrantQualifACM = '',
    this.denomEtablissement = '',
    this.encadrantNomPrenomPresta = '',
    this.encadrantQualifPresta = '',
    this.numCarteProPresta = '',
    this.radioAqua = '',
    this.radioAutorisations = '',
    this.observationsIsolation = '',
    this.observationsVaccination = '',
    this.observationsAntecedents = '',
    this.observationsMineurTraitement = '',
    this.observationsAllergies = '',
    this.observationsOrdonnances = '',
    this.observationsRegistreSoins = '',
    this.observationsPremierSoins = '',
    this.observationsCommSecours = '',
    this.observationsNumUrgence = '',
    this.radioIsolation = '',
    this.radioVaccination = '',
    this.radioAntecedents = '',
    this.radioMineurTraitement = '',
    this.radioAllergies = '',
    this.radioOrdonnances = '',
    this.radioRegistreSoins = '',
    this.radioPremierSoins = '',
    this.radioCommSecours = '',
    this.radioNumUrgence = '',
    this.radioCommissionSecu = '',
    this.radioAssurance = '',
    this.radioSignaletique = '',
    this.radioEvacuation = '',
    this.radioExtincteur = '',
    this.radioDetecteur = '',
    this.radioExercice = '',
    this.radioConditionsMeteo = '',
    this.radioHygiene = '',
    this.radioCouchage = '',
    this.radioHebergeDirection = '',
    this.radioSanitaire = '',
    this.radioSieste = '',
    this.radioEspacesAdapte = '',
    this.radioRepli = '',
    this.observationsCommissionSecu = '',
    this.observationsAssurance = '',
    this.observationsSignaletique = '',
    this.observationsEvacuation = '',
    this.observationsExtincteur = '',
    this.observationsDetecteur = '',
    this.observationsExercice = '',
    this.observationsConditionsMeteo = '',
    this.observationsHygiene = '',
    this.observationsCouchage = '',
    this.observationsHebergeDirection = '',
    this.observationsSanitaire = '',
    this.observationsSieste = '',
    this.observationsEspacesAdapte = '',
    this.observationsRepli = '',
    this.radioCuisine = '',
    this.radioSalleResto = '',
    this.radioPiqueNique = '',
    this.radioPlatsTemoins = '',
    this.radioTracabilite = '',
    this.radioStockage = '',
    this.radioRefrigerateur = '',
    this.observationsCuisine = '',
    this.observationsSalleResto = '',
    this.observationsPlatsTemoins = '',
    this.observationsTracabilite = '',
    this.observationsStockage = '',
    this.observationsRefrigerateur = '',
    this.observationsPiqueNique = '',
    this.radioGestion = '',
    this.radioVeille = '',
    this.radioPreventionChaleur = '',
    this.radioEquipement = '',
    this.radioPieceFraiche = '',
    this.radioVentilateurs = '',
    this.radioThermo = '',
    this.radioEauMenus = '',
    this.radioReserves = '',
    this.radioOmbre = '',
    this.radioRafraichissement = '',
    this.radioGesteBarriere = '',
    this.radioGestionPosteriori = '',
    this.observationsGestion = '',
    this.observationsVeille = '',
    this.observationsPreventionChaleur = '',
    this.observationsEquipement = '',
    this.observationsPieceFraiche = '',
    this.observationsVentilateurs = '',
    this.observationsThermo = '',
    this.observationsEauMenus = '',
    this.observationsReserves = '',
    this.observationsOmbre = '',
    this.observationsRafraichissement = '',
    this.observationsGesteBarriere = '',
    this.observationsGestionPosteriori = '',
    this.appreciationGenerale = '',
    this.prescriptionsEcheances = '',
    this.controllerName = '',
    DateTime? dateVisite,
    DateTime? startDate,
    DateTime? endDate,
    DateTime? dateRenouvellement,
    DateTime? dateDebutFormation,
    DateTime? dateStartDerogation,
    DateTime? dateEndDerogation,
    DateTime? dateDuControle,
    this.copyTo = const [],
    this.radioTypeAccueil = const [],
    this.checkEtape1ActiviteType = const [],
    this.CopyToTest = '',
    this.signatureAuthorite = const [],
    this.activitesSecu,
  })  : dateVisite = dateVisite ?? DateTime(2001, 1, 1),
        startDate = startDate ?? DateTime(2001, 1, 1),
        endDate = endDate ?? DateTime(2001, 1, 1),
        dateRenouvellement = dateRenouvellement ?? DateTime(2001, 1, 1),
        dateDebutFormation = dateDebutFormation ?? DateTime(2001, 1, 1),
        dateStartDerogation = dateStartDerogation ?? DateTime(2001, 1, 1),
        dateEndDerogation = dateEndDerogation ?? DateTime(2001, 1, 1),
        dateDuControle = dateDuControle ?? DateTime(2001, 1, 1);

  factory AvecHData.fromJson(Map<String, dynamic> json) {
    return AvecHData(
      visiteRealiseePar: json['visiteRealiseePar'] ?? '',
      enPresenceDe: json['enPresenceDe'] ?? '',
      denomination: json['denomination'] ?? '',
      adresse: json['adresse'] ?? '',
      lieu: json['lieu'] ?? '',
      numeroDeclaration: json['numeroDeclaration'] ?? '',
      radio227_5: json['radio227_5'] ?? '',
      radio227_29: json['radio227_29'] ?? '',
      observations227_5: json['observations227_5'] ?? '',
      observations227_29: json['observations227_29'] ?? '',
      capaciteAccueil: json['capaciteAccueil'] ?? '',
      moinsDe6AnsDeclares: json['moinsDe6AnsDeclares'] ?? '',
      entre6et13AnsDeclares: json['entre6et13AnsDeclares'] ?? '',
      entre14et17AnsDeclares: json['entre14et17AnsDeclares'] ?? '',
      moinsDe6AnsPresents: json['moinsDe6AnsPresents'] ?? '',
      entre6et13AnsPresents: json['entre6et13AnsPresents'] ?? '',
      entre14et17AnsPresents: json['entre14et17AnsPresents'] ?? '',
      moinsDe6AnsHandi: json['moinsDe6AnsHandi'] ?? '',
      entre6et13AnsHandi: json['entre6et13AnsHandi'] ?? '',
      entre14et17AnsHandi: json['entre14et17AnsHandi'] ?? '',
      totalDeclares: json['totalDeclares'] ?? '',
      totalPresents: json['totalPresents'] ?? '',
      totalHandi: json['totalHandi'] ?? '',
      radio2324_13: json['radio2324_13'] ?? '',
      radio2324_14: json['radio2324_14'] ?? '',
      observations2324_13: json['observations2324_13'] ?? '',
      observations2324_14: json['observations2324_14'] ?? '',
      radioRegistreMineur: json['radioRegistreMineur'] ?? '',
      observationsRegistreMineur: json['observationsRegistreMineur'] ?? '',
      directeurNom: json['directeurNom'] ?? '',
      directeurPrenom: json['directeurPrenom'] ?? '',
      directeurQualification: json['directeurQualification'] ?? '',
      radioTitulaireStagiaire: json['radioTitulaireStagiaire'] ?? '',
      adjointNom: json['adjointNom'] ?? '',
      adjointPrenom: json['adjointPrenom'] ?? '',
      adjointQualif: json['adjointQualif'] ?? '',
      nombreAnimQualif: json['nombreAnimQualif'] ?? '',
      nombreAnimStagiaires: json['nombreAnimStagiaires'] ?? '',
      nombreAnimNonQualif: json['nombreAnimNonQualif'] ?? '',
      totalAnim: json['totalAnim'] ?? '',
      encadrementRequisMoinsDe6: json['encadrementRequisMoinsDe6'] ?? '',
      encadrementRequisPlusDe6: json['encadrementRequisPlusDe6'] ?? '',
      totalAnimRequis: json['totalAnimRequis'] ?? '',
      radio227_2: json['radio227_2'] ?? '',
      observations227_2: json['observations227_2'] ?? '',
      radioArrete3_5: json['radioArrete3_5'] ?? '',
      observationsArrete3_5: json['observationsArrete3_5'] ?? '',
      radio9_02_07: json['radio9_02_07'] ?? '',
      observations9_02_07: json['observations9_02_07'] ?? '',
      radio227_8: json['radio227_8'] ?? '',
      observations227_8: json['observations227_8'] ?? '',
      radioSuiviSanitaire: json['radioSuiviSanitaire'] ?? '',
      observationsSuiviSanitaire: json['observationsSuiviSanitaire'] ?? '',
      observationsCommunicationOrganisateur: json['observationsCommunicationOrganisateur'] ?? '',
      observationsSavoirComportement: json['observationsSavoirComportement'] ?? '',
      observationsQualifPersonnel: json['observationsQualifPersonnel'] ?? '',
      observationsTempsDePrep: json['observationsTempsDePrep'] ?? '',
      observationsReuBilan: json['observationsReuBilan'] ?? '',
      observationsEvalStg: json['observationsEvalStg'] ?? '',
      radioProjEdu: json['radioProjEdu'] ?? '',
      observationsProjEdu: json['observationsProjEdu'] ?? '',
      radioProjPeda: json['radioProjPeda'] ?? '',
      observationsProjPeda: json['observationsProjPeda'] ?? '',
      radioRepresentant: json['radioRepresentant'] ?? '',
      observationsRepresentant: json['observationsRepresentant'] ?? '',
      observationsPE: json['observationsPE'] ?? '',
      observationsMoyens: json['observationsMoyens'] ?? '',
      observationsMoyensEquipe: json['observationsMoyensEquipe'] ?? '',
      observationsBudget: json['observationsBudget'] ?? '',
      observationsOrientation: json['observationsOrientation'] ?? '',
      observationsDiagnostic: json['observationsDiagnostic'] ?? '',
      observationsPolitique: json['observationsPolitique'] ?? '',
      observationsReorientation: json['observationsReorientation'] ?? '',
      observationsPPCoherence: json['observationsPPCoherence'] ?? '',
      observationsPPCara: json['observationsPPCara'] ?? '',
      observationsPPConcertation: json['observationsPPConcertation'] ?? '',
      observationsPPModalite: json['observationsPPModalite'] ?? '',
      observationsPPNature: json['observationsPPNature'] ?? '',
      observationsPPRepartition: json['observationsPPRepartition'] ?? '',
      observationsSecuriteNuit: json['observationsSecuriteNuit'] ?? '',
      observationsPPSanteHandi: json['observationsPPSanteHandi'] ?? '',
      observationsPPFonctEquipe: json['observationsPPFonctEquipe'] ?? '',
      observationsPPEvalAccueil: json['observationsPPEvalAccueil'] ?? '',
      observationsActivitesType: json['observationsActivitesType'] ?? '',
      observationsPrestataire: json['observationsPrestataire'] ?? '',
      observationsActiviteMineur: json['observationsActiviteMineur'] ?? '',
      observationsRisques: json['observationsRisques'] ?? '',
      observationsEchange: json['observationsEchange'] ?? '',
      observationsFormation: json['observationsFormation'] ?? '',
      nomActivite: json['nomActivite'] ?? '',
      encadrantNomPrenomACM: json['encadrantNomPrenomACM'] ?? '',
      encadrantQualifACM: json['encadrantQualifACM'] ?? '',
      denomEtablissement: json['denomEtablissement'] ?? '',
      encadrantNomPrenomPresta: json['encadrantNomPrenomPresta'] ?? '',
      encadrantQualifPresta: json['encadrantQualifPresta'] ?? '',
      numCarteProPresta: json['numCarteProPresta'] ?? '',
      radioAqua: json['radioAqua'] ?? '',
      radioAutorisations: json['radioAutorisations'] ?? '',
      observationsIsolation: json['observationsIsolation'] ?? '',
      observationsVaccination: json['observationsVaccination'] ?? '',
      observationsAntecedents: json['observationsAntecedents'] ?? '',
      observationsMineurTraitement: json['observationsMineurTraitement'] ?? '',
      observationsAllergies: json['observationsAllergies'] ?? '',
      observationsOrdonnances: json['observationsOrdonnances'] ?? '',
      observationsRegistreSoins: json['observationsRegistreSoins'] ?? '',
      observationsPremierSoins: json['observationsPremierSoins'] ?? '',
      observationsCommSecours: json['observationsCommSecours'] ?? '',
      observationsNumUrgence: json['observationsNumUrgence'] ?? '',
      radioIsolation: json['radioIsolation'] ?? '',
      radioVaccination: json['radioVaccination'] ?? '',
      radioAntecedents: json['radioAntecedents'] ?? '',
      radioMineurTraitement: json['radioMineurTraitement'] ?? '',
      radioAllergies: json['radioAllergies'] ?? '',
      radioOrdonnances: json['radioOrdonnances'] ?? '',
      radioRegistreSoins: json['radioRegistreSoins'] ?? '',
      radioPremierSoins: json['radioPremierSoins'] ?? '',
      radioCommSecours: json['radioCommSecours'] ?? '',
      radioNumUrgence: json['radioNumUrgence'] ?? '',
      radioCommissionSecu: json['radioCommissionSecu'] ?? '',
      radioAssurance: json['radioAssurance'] ?? '',
      radioSignaletique: json['radioSignaletique'] ?? '',
      radioEvacuation: json['radioEvacuation'] ?? '',
      radioExtincteur: json['radioExtincteur'] ?? '',
      radioDetecteur: json['radioDetecteur'] ?? '',
      radioExercice: json['radioExercice'] ?? '',
      radioConditionsMeteo: json['radioConditionsMeteo'] ?? '',
      radioHygiene: json['radioHygiene'] ?? '',
      radioCouchage: json['radioCouchage'] ?? '',
      radioHebergeDirection: json['radioHebergeDirection'] ?? '',
      radioSanitaire: json['radioSanitaire'] ?? '',
      radioSieste: json['radioSieste'] ?? '',
      radioEspacesAdapte: json['radioEspacesAdapte'] ?? '',
      radioRepli: json['radioRepli'] ?? '',
      observationsCommissionSecu: json['observationsCommissionSecu'] ?? '',
      observationsAssurance: json['observationsAssurance'] ?? '',
      observationsSignaletique: json['observationsSignaletique'] ?? '',
      observationsEvacuation: json['observationsEvacuation'] ?? '',
      observationsExtincteur: json['observationsExtincteur'] ?? '',
      observationsDetecteur: json['observationsDetecteur'] ?? '',
      observationsExercice: json['observationsExercice'] ?? '',
      observationsConditionsMeteo: json['observationsConditionsMeteo'] ?? '',
      observationsHygiene: json['observationsHygiene'] ?? '',
      observationsCouchage: json['observationsCouchage'] ?? '',
      observationsHebergeDirection: json['observationsHebergeDirection'] ?? '',
      observationsSanitaire: json['observationsSanitaire'] ?? '',
      observationsSieste: json['observationsSieste'] ?? '',
      observationsEspacesAdapte: json['observationsEspacesAdapte'] ?? '',
      observationsRepli: json['observationsRepli'] ?? '',
      radioCuisine: json['radioCuisine'] ?? '',
      radioSalleResto: json['radioSalleResto'] ?? '',
      radioPiqueNique: json['radioPiqueNique'] ?? '',
      radioPlatsTemoins: json['radioPlatsTemoins'] ?? '',
      radioTracabilite: json['radioTracabilite'] ?? '',
      radioStockage: json['radioStockage'] ?? '',
      radioRefrigerateur: json['radioRefrigerateur'] ?? '',
      observationsCuisine: json['observationsCuisine'] ?? '',
      observationsSalleResto: json['observationsSalleResto'] ?? '',
      observationsPlatsTemoins: json['observationsPlatsTemoins'] ?? '',
      observationsTracabilite: json['observationsTracabilite'] ?? '',
      observationsStockage: json['observationsStockage'] ?? '',
      observationsRefrigerateur: json['observationsRefrigerateur'] ?? '',
      observationsPiqueNique: json['observationsPiqueNique'] ?? '',
      radioGestion: json['radioGestion'] ?? '',
      radioVeille: json['radioVeille'] ?? '',
      radioPreventionChaleur: json['radioPreventionChaleur'] ?? '',
      radioEquipement: json['radioEquipement'] ?? '',
      radioPieceFraiche: json['radioPieceFraiche'] ?? '',
      radioVentilateurs: json['radioVentilateurs'] ?? '',
      radioThermo: json['radioThermo'] ?? '',
      radioEauMenus: json['radioEauMenus'] ?? '',
      radioReserves: json['radioReserves'] ?? '',
      radioOmbre: json['radioOmbre'] ?? '',
      radioRafraichissement: json['radioRafraichissement'] ?? '',
      radioGesteBarriere: json['radioGesteBarriere'] ?? '',
      radioGestionPosteriori: json['radioGestionPosteriori'] ?? '',
      observationsGestion: json['observationsGestion'] ?? '',
      observationsVeille: json['observationsVeille'] ?? '',
      observationsPreventionChaleur: json['observationsPreventionChaleur'] ?? '',
      observationsEquipement: json['observationsEquipement'] ?? '',
      observationsPieceFraiche: json['observationsPieceFraiche'] ?? '',
      observationsVentilateurs: json['observationsVentilateurs'] ?? '',
      observationsThermo: json['observationsThermo'] ?? '',
      observationsEauMenus: json['observationsEauMenus'] ?? '',
      observationsReserves: json['observationsReserves'] ?? '',
      observationsOmbre: json['observationsOmbre'] ?? '',
      observationsRafraichissement: json['observationsRafraichissement'] ?? '',
      observationsGesteBarriere: json['observationsGesteBarriere'] ?? '',
      observationsGestionPosteriori: json['observationsGestionPosteriori'] ?? '',
      appreciationGenerale: json['appreciationGenerale'] ?? '',
      prescriptionsEcheances: json['prescriptionsEcheances'] ?? '',
      controllerName: json['controllerName'] ?? '',
      dateVisite: json["dateVisite"] != null ? DateTime.parse(json["dateVisite"]) : null,
      startDate: json["startDate"] != null ? DateTime.parse(json["startDate"]) : null,
      endDate: json["endDate"] != null ? DateTime.parse(json["endDate"]) : null,
      dateRenouvellement: json["dateRenouvellement"] != null ? DateTime.parse(json["dateRenouvellement"]) : null,
      dateDebutFormation: json["dateDebutFormation"] != null ? DateTime.parse(json["dateDebutFormation"]) : null,
      dateStartDerogation: json["dateStartDerogation"] != null ? DateTime.parse(json["dateStartDerogation"]) : null,
      dateEndDerogation: json["dateEndDerogation"] != null ? DateTime.parse(json["dateEndDerogation"]) : null,
      dateDuControle: json["dateDuControle"] != null ? DateTime.parse(json["dateDuControle"]) : null,
      copyTo: List<String>.from(json['copyTo'] ?? []),
      radioTypeAccueil: List<String>.from(json['radioTypeAccueil'] ?? []),
      checkEtape1ActiviteType: List<String>.from(json['checkEtape1ActiviteType'] ?? []),
      CopyToTest: json['CopyToTest'] ?? '',
      signatureAuthorite: List<String>.from(json['signatureAuthorite'] ?? []),
      activitesSecu: json['activitesSecu'] != null
          ? ActivitesSecu.fromJson(json['activitesSecu'])
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      'visiteRealiseePar': visiteRealiseePar,
      'enPresenceDe': enPresenceDe,
      'denomination': denomination,
      'adresse': adresse,
      'lieu': lieu,
      'numeroDeclaration': numeroDeclaration,
      'radio227_5': radio227_5,
      'radio227_29': radio227_29,
      'observations227_5': observations227_5,
      'observations227_29': observations227_29,
      'capaciteAccueil': capaciteAccueil,
      'moinsDe6AnsDeclares': moinsDe6AnsDeclares,
      'entre6et13AnsDeclares': entre6et13AnsDeclares,
      'entre14et17AnsDeclares': entre14et17AnsDeclares,
      'moinsDe6AnsPresents': moinsDe6AnsPresents,
      'entre6et13AnsPresents': entre6et13AnsPresents,
      'entre14et17AnsPresents': entre14et17AnsPresents,
      'moinsDe6AnsHandi': moinsDe6AnsHandi,
      'entre6et13AnsHandi': entre6et13AnsHandi,
      'entre14et17AnsHandi': entre14et17AnsHandi,
      'totalDeclares': totalDeclares,
      'totalPresents': totalPresents,
      'totalHandi': totalHandi,
      'radio2324_13': radio2324_13,
      'radio2324_14': radio2324_14,
      'observations2324_13': observations2324_13,
      'observations2324_14': observations2324_14,
      'radioRegistreMineur': radioRegistreMineur,
      'observationsRegistreMineur': observationsRegistreMineur,
      'directeurNom': directeurNom,
      'directeurPrenom': directeurPrenom,
      'directeurQualification': directeurQualification,
      'radioTitulaireStagiaire': radioTitulaireStagiaire,
      'adjointNom': adjointNom,
      'adjointPrenom': adjointPrenom,
      'adjointQualif': adjointQualif,
      'nombreAnimQualif': nombreAnimQualif,
      'nombreAnimStagiaires': nombreAnimStagiaires,
      'nombreAnimNonQualif': nombreAnimNonQualif,
      'totalAnim': totalAnim,
      'encadrementRequisMoinsDe6': encadrementRequisMoinsDe6,
      'encadrementRequisPlusDe6': encadrementRequisPlusDe6,
      'totalAnimRequis': totalAnimRequis,
      'radio227_2': radio227_2,
      'observations227_2': observations227_2,
      'radioArrete3_5': radioArrete3_5,
      'observationsArrete3_5': observationsArrete3_5,
      'radio9_02_07': radio9_02_07,
      'observations9_02_07': observations9_02_07,
      'radio227_8': radio227_8,
      'observations227_8': observations227_8,
      'radioSuiviSanitaire': radioSuiviSanitaire,
      'observationsSuiviSanitaire': observationsSuiviSanitaire,
      'observationsCommunicationOrganisateur': observationsCommunicationOrganisateur,
      'observationsSavoirComportement': observationsSavoirComportement,
      'observationsQualifPersonnel': observationsQualifPersonnel,
      'observationsTempsDePrep': observationsTempsDePrep,
      'observationsReuBilan': observationsReuBilan,
      'observationsEvalStg': observationsEvalStg,
      'radioProjEdu': radioProjEdu,
      'observationsProjEdu': observationsProjEdu,
      'radioProjPeda': radioProjPeda,
      'observationsProjPeda': observationsProjPeda,
      'radioRepresentant': radioRepresentant,
      'observationsRepresentant': observationsRepresentant,
      'observationsPE': observationsPE,
      'observationsMoyens': observationsMoyens,
      'observationsMoyensEquipe': observationsMoyensEquipe,
      'observationsBudget': observationsBudget,
      'observationsOrientation': observationsOrientation,
      'observationsDiagnostic': observationsDiagnostic,
      'observationsPolitique': observationsPolitique,
      'observationsReorientation': observationsReorientation,
      'observationsPPCoherence': observationsPPCoherence,
      'observationsPPCara': observationsPPCara,
      'observationsPPConcertation': observationsPPConcertation,
      'observationsPPModalite': observationsPPModalite,
      'observationsPPNature': observationsPPNature,
      'observationsPPRepartition': observationsPPRepartition,
      'observationsSecuriteNuit': observationsSecuriteNuit,
      'observationsPPSanteHandi': observationsPPSanteHandi,
      'observationsPPFonctEquipe': observationsPPFonctEquipe,
      'observationsPPEvalAccueil': observationsPPEvalAccueil,
      'observationsActivitesType': observationsActivitesType,
      'observationsPrestataire': observationsPrestataire,
      'observationsActiviteMineur': observationsActiviteMineur,
      'observationsRisques': observationsRisques,
      'observationsEchange': observationsEchange,
      'observationsFormation': observationsFormation,
      'nomActivite': nomActivite,
      'encadrantNomPrenomACM': encadrantNomPrenomACM,
      'encadrantQualifACM': encadrantQualifACM,
      'denomEtablissement': denomEtablissement,
      'encadrantNomPrenomPresta': encadrantNomPrenomPresta,
      'encadrantQualifPresta': encadrantQualifPresta,
      'numCarteProPresta': numCarteProPresta,
      'radioAqua': radioAqua,
      'radioAutorisations': radioAutorisations,
      'observationsIsolation': observationsIsolation,
      'observationsVaccination': observationsVaccination,
      'observationsAntecedents': observationsAntecedents,
      'observationsMineurTraitement': observationsMineurTraitement,
      'observationsAllergies': observationsAllergies,
      'observationsOrdonnances': observationsOrdonnances,
      'observationsRegistreSoins': observationsRegistreSoins,
      'observationsPremierSoins': observationsPremierSoins,
      'observationsCommSecours': observationsCommSecours,
      'observationsNumUrgence': observationsNumUrgence,
      'radioIsolation': radioIsolation,
      'radioVaccination': radioVaccination,
      'radioAntecedents': radioAntecedents,
      'radioMineurTraitement': radioMineurTraitement,
      'radioAllergies': radioAllergies,
      'radioOrdonnances': radioOrdonnances,
      'radioRegistreSoins': radioRegistreSoins,
      'radioPremierSoins': radioPremierSoins,
      'radioCommSecours': radioCommSecours,
      'radioNumUrgence': radioNumUrgence,
      'radioCommissionSecu': radioCommissionSecu,
      'radioAssurance': radioAssurance,
      'radioSignaletique': radioSignaletique,
      'radioEvacuation': radioEvacuation,
      'radioExtincteur': radioExtincteur,
      'radioDetecteur': radioDetecteur,
      'radioExercice': radioExercice,
      'radioConditionsMeteo': radioConditionsMeteo,
      'radioHygiene': radioHygiene,
      'radioCouchage': radioCouchage,
      'radioHebergeDirection': radioHebergeDirection,
      'radioSanitaire': radioSanitaire,
      'radioSieste': radioSieste,
      'radioEspacesAdapte': radioEspacesAdapte,
      'radioRepli': radioRepli,
      'observationsCommissionSecu': observationsCommissionSecu,
      'observationsAssurance': observationsAssurance,
      'observationsSignaletique': observationsSignaletique,
      'observationsEvacuation': observationsEvacuation,
      'observationsExtincteur': observationsExtincteur,
      'observationsDetecteur': observationsDetecteur,
      'observationsExercice': observationsExercice,
      'observationsConditionsMeteo': observationsConditionsMeteo,
      'observationsHygiene': observationsHygiene,
      'observationsCouchage': observationsCouchage,
      'observationsHebergeDirection': observationsHebergeDirection,
      'observationsSanitaire': observationsSanitaire,
      'observationsSieste': observationsSieste,
      'observationsEspacesAdapte': observationsEspacesAdapte,
      'observationsRepli': observationsRepli,
      'radioCuisine': radioCuisine,
      'radioSalleResto': radioSalleResto,
      'radioPiqueNique': radioPiqueNique,
      'radioPlatsTemoins': radioPlatsTemoins,
      'radioTracabilite': radioTracabilite,
      'radioStockage': radioStockage,
      'radioRefrigerateur': radioRefrigerateur,
      'observationsCuisine': observationsCuisine,
      'observationsSalleResto': observationsSalleResto,
      'observationsPlatsTemoins': observationsPlatsTemoins,
      'observationsTracabilite': observationsTracabilite,
      'observationsStockage': observationsStockage,
      'observationsRefrigerateur': observationsRefrigerateur,
      'observationsPiqueNique': observationsPiqueNique,
      'radioGestion': radioGestion,
      'radioVeille': radioVeille,
      'radioPreventionChaleur': radioPreventionChaleur,
      'radioEquipement': radioEquipement,
      'radioPieceFraiche': radioPieceFraiche,
      'radioVentilateurs': radioVentilateurs,
      'radioThermo': radioThermo,
      'radioEauMenus': radioEauMenus,
      'radioReserves': radioReserves,
      'radioOmbre': radioOmbre,
      'radioRafraichissement': radioRafraichissement,
      'radioGesteBarriere': radioGesteBarriere,
      'radioGestionPosteriori': radioGestionPosteriori,
      'observationsGestion': observationsGestion,
      'observationsVeille': observationsVeille,
      'observationsPreventionChaleur': observationsPreventionChaleur,
      'observationsEquipement': observationsEquipement,
      'observationsPieceFraiche': observationsPieceFraiche,
      'observationsVentilateurs': observationsVentilateurs,
      'observationsThermo': observationsThermo,
      'observationsEauMenus': observationsEauMenus,
      'observationsReserves': observationsReserves,
      'observationsOmbre': observationsOmbre,
      'observationsRafraichissement': observationsRafraichissement,
      'observationsGesteBarriere': observationsGesteBarriere,
      'observationsGestionPosteriori': observationsGestionPosteriori,
      'appreciationGenerale': appreciationGenerale,
      'prescriptionsEcheances': prescriptionsEcheances,
      'controllerName': controllerName,
      'dateVisite': dateVisite.toIso8601String(),
      'startDate': startDate.toIso8601String(),
      'endDate': endDate.toIso8601String(),
      'dateRenouvellement': dateRenouvellement.toIso8601String(),
      'dateDebutFormation': dateDebutFormation.toIso8601String(),
      'dateStartDerogation': dateStartDerogation.toIso8601String(),
      'dateEndDerogation': dateEndDerogation.toIso8601String(),
      'dateDuControle': dateDuControle.toIso8601String(),
      'copyTo': copyTo,
      'radioTypeAccueil': radioTypeAccueil,
      'checkEtape1ActiviteType': checkEtape1ActiviteType,
      'CopyToTest': CopyToTest,
      'signatureAuthorite': signatureAuthorite,
      'activitesSecu': activitesSecu?.toJson(),
    };*/
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (currentStep == 5) SixthSection(avecHData),
                if (currentStep == 6) SeventhSection(avecHData),
                if (currentStep == 7) EighthSection(avecHData),
                if (currentStep == 8) NinthSection(avecHData),
                if (currentStep == 9) TenthSection(avecHData),
              ],
            ),
          ),
        ),
